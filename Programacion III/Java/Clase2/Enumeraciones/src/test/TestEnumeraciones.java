...
public class TestEnumeraciones {
    public static void main(String[] args) {
       // System.out.println("Dia 1: "+Dias.LUNES);
        //indicarDiaSemana(Dias.MIERCOLES); //Las enumeraciones se tratan como cadena
        //ahora no se debe utilizar comillas, se accede a traves del operador de punto
        
        //AFRICA
                System.out.println("Continentes No. 1: "+Continentes.AFRICA);
        System.out.println("No. de paises en el 1to continente: "
       ...
       //EUROPA     
        ...
        System.out.println("No. de paises en el 2to continente: "
        ...
        System.out.println("No. de paises en el 3to continente: "
